...
def main():
    ...
    tokenized_train = ds['train'].map(lambda ex: preprocess_function(ex, tokenizer), batched=True)
    tokenized_eval = ds['test'].map(lambda ex: preprocess_function(ex, tokenizer), batched=True)
